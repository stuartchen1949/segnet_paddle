...
class VOCDataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        file_list = os.path.join(self.root, 'ImageSets/Segmentation', self.
            split + '.txt')
...
class VOCAugDataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        file_list = os.path.join(self.root, 'ImageSets/Segmentation', self.
            split + '.txt')
        file_list = [line.rstrip().split(' ') for line in tuple(open(
            file_list, 'r'))]
...
class VOC(BaseDataLoader):
    ...
    def __init__(self, data_dir, batch_size, split, crop_size=None,
        base_size=None, scale=True, num_workers=1, val=False, shuffle=False,
        flip=False, rotate=False, blur=False, augment=False, val_split=None,
        return_id=False):
        ...
        super(VOC, self).__init__(self.dataset, batch_size, shuffle,
